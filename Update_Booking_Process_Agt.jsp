...
<% 
    ...
    try
    {
        ...
        String myquery="Update booking_agent set date='"+dt+"',fname='"+fname+"',lname='"+lname+"',phone_no='"+phone_no+"',email='"+email+"',booking_amt='"+booking_amt+"',entry_by='"+entry_by+"'where custid="+idx;
