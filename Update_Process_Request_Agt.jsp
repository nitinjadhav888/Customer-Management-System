...
<%
    ...
    try {
        ...
        String sql = "UPDATE Request_Raise_Agent SET request_date='" + request_date + "', request_time='" + request_time + "', request_details='" + request_details + "', request_priority='" + request_priority + "', request_raised_by='" + request_raised_by + "' WHERE request_id='" + request_id + "'";
        
        int updated = stmt.executeUpdate(sql);

        conn.close();

       response.sendRedirect("Display_Request_Raise_Agt.jsp");
    } catch (Exception e) {
        out.println("Error: " + e);
    }
%>
