...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
                    ...
                    <a href="EnquiryForm_Agt.jsp" class="btn btn-info">
 ...
 try
    {
        ...
        String sql ="select * from enquiry_agent where status = 'Follow Up'";
        ...
        while(rs.next())
        {
           ...
           <tr>
               ...
               <td><%=rs.getString("STATUS")%></td>
                ...
                <td class="text-center"><a href="Delete_Enquiry_Agt.jsp?id=<%=rs.getInt("enqid")%>" class="btn btn-danger" onclick="return getConfirmation()">
                       <span class="glyphicon glyphicon-trash"></span> Delete
                   </a>
               </td>
               <td><a href="Update_Enquiry_Agt.jsp?id=<%=rs.getInt("enqid")%>" class="btn btn-success">
