    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            function getConfirmation()
            {
               ...
               if(res==true)
               {
                  window.location.href="Display_Booking_Adm.jsp"; 
               }
               else
               {
                   return false;
    ...
    <body>
        ...
        <div class="container-fluid">
            <form>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                    <a href="BookingForm_Emp.jsp" class="btn btn-info">
...
<% 
                            ...
                            if(x_btn!=null)
                            {
                                String fetch_record= request.getParameter("search_req_data");
                                 sql ="select * from booking where custid = '"+fetch_record+"' or fname='"+fetch_record+"' or lname='"+fetch_record+"'or phone_no='"+fetch_record+"'or email='"+fetch_record+"'or booking_amt='"+fetch_record+"' or entry_by='"+fetch_record+"'";
                            ...
                            {
                                 sql ="select * from booking order by custid desc";
                            }
%>                            
       ...
       // String sql ="select * from booking order by CUSTID desc";
        ...
        while(rs.next())
        {
           ...
           <tr>
               ...
               <td class="text-center"><a href="Delete_Booking_Emp.jsp?id=<%=rs.getInt("custid")%>" class="btn btn-danger" onclick="return getConfirmation()">
                       <span class="glyphicon glyphicon-trash"></span> Delete
                   </a>
               </td>
               <td><a href="Update_Booking_Emp.jsp?id=<%=rs.getInt("custid")%>" class="btn btn-success">
