...
<%
    ...
    try
    {
      ...
      Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Skyline_DB","root","");
       ...
       int i=st.executeUpdate("insert into enquiry_agent (FNAME,LNAME,PHONE_NO,EMAIL,MIN_BUDGET,MAX_BUDGET,TYPE_OF_PROPERTY,SUGG_COST,STATUS)values('"+fname+"','"+lname+"','"+phone_no+"','"+email+"','"+min_budget+"','"+max_budget+"','"+type_of_property+"','"+sugg_cost+"','"+status+"')");
