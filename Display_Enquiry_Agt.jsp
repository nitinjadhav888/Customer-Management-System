    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js">
        ...
        <script>
            function getConfirmation()
            {
               ...
               if(res==true)
               {
                  window.location.href="DisplayEnquiry_Agt.jsp"; 
               }
               else
               {
                   return false;
    ...
    <body>
        ...
        <div class="container-fluid">
            <form>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                    <a href="New_Enquiry_Form_Agt.jsp" class="btn btn-info">
...
<% 
                            ...
                            if(x_btn!=null)
                            {
                                String fetch_record= request.getParameter("search_req_data");
                                 sql ="select * from enquiry_agent where enqid = '"+fetch_record+"' or fname='"+fetch_record+"' or lname='"+fetch_record+"'or phone_no='"+fetch_record+"'or email='"+fetch_record+"'or min_budget='"+fetch_record+"' or max_budget='"+fetch_record+"' or type_of_property='"+fetch_record+"'or sugg_cost='"+fetch_record+"'or status='"+fetch_record+"'";
                            ...
                            {
                                 sql ="select * from enquiry_agent order by enqid desc";
                            }
%>
       ...
       // String sql ="select * from enquiry order by ENQID desc";
        ...
        while(rs.next())
        {
           ...
           <tr>
               ...
               <td class="text-center"><a href="Delete_Enquiry_Agent.jsp?id=<%=rs.getInt("enqid")%>" class="btn btn-danger" onclick="return getConfirmation()">
                       <span class="glyphicon glyphicon-trash"></span> Delete
                   </a>
               </td>
               <td><a href="Update_Enquiry_Agent.jsp?id=<%=rs.getInt("enqid")%>" class="btn btn-success">
