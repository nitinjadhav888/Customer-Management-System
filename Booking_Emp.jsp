...
<%
    ...
    try
    {
      ...
      Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Skyline_DB","root","");
       ...
       int i=st.executeUpdate("insert into booking (DATE,FNAME,LNAME,PHONE_NO,EMAIL,BOOKING_AMT,ENTRY_BY)values('"+dt+"','"+fname+"','"+lname+"','"+phone_no+"','"+email+"','"+booking_amt+"','"+entry_by+"')");
