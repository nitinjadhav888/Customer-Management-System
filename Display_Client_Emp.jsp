...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                    <a href="ClientForm_Emp.jsp" class="btn btn-info">
...
<% 
                            ...
                            if(x_btn!=null)
                            {
                                String fetch_record= request.getParameter("search_req_data");
                                 sql ="select * from client where clientid = '"+fetch_record+"' or date='"+fetch_record+"' or fname='"+fetch_record+"' or lname='"+fetch_record+"'or p_for='"+fetch_record+"'or p_mode='"+fetch_record+"'or p_amt='"+fetch_record+"' or p_entry='"+fetch_record+"'";
       ...
       // String sql ="select * from client order by CLIENTID desc";
        ...
        while(rs.next())
        {
           ...
           <tr>
               ...
               <td><%=rs.getString("P_FOR")%></td>
               <td><%=rs.getString("P_MODE")%></td>
               <td><%=rs.getString("P_AMT")%></td>
               <td><%=rs.getString("P_ENTRY")%></td>
              
               <td class="text-center"><a href="Delete_Client_Emp.jsp?id=<%=rs.getInt("clientid")%>" class="btn btn-danger" onclick="return getConfirmation()">
                       <span class="glyphicon glyphicon-trash"></span> Delete
                   </a>
               </td>
               <td><a href="Update_Client_Emp.jsp?id=<%=rs.getInt("clientid")%>" class="btn btn-success">
