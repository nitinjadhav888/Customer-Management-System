...
<%
    ...
    try
    {
      ...
      Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Skyline_DB","root","");
       ...
       int i=st.executeUpdate("INSERT INTO sales_entry_emp (FNAME, LNAME, PHONE_NO, EMAIL, PAN_CARD, AADHAR_CARD, CASH_AMOUNT, LOAN_AMOUNT,DATE, ENTRY_BY) VALUES ('"+fname+"','"+lname+"','"+phone_no+"','"+email+"','"+pan_card+"','"+aadhar_card+"','"+cash_amount+"','"+loan_amount+"','"+date+"','"+entry_by+"')");
     
       response.sendRedirect("Display_Sales_Emp.jsp");
    }
