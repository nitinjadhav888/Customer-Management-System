    ...
    <head>
        ...
        <script>
            function getConfirmation() {
                ...
                if (res == true) {
                    window.location.href = "DisplayRequest_Agt.jsp"; 
                } else {
                    return false;
                }
            }
    ...
    <body>
        ...
        <div class="container-fluid">
            <form>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="RequestForm_Agt.jsp" class="btn btn-info">
                ...
                <table class="table table-bordered">
                    ...
                    <% 
                        ...
                        if (x_btn != null) {
                            ...
                            sql = "SELECT * FROM Request_Raise_Agent WHERE request_id = '"+fetch_record+"' OR request_date = '"+fetch_record+"' OR request_priority = '"+fetch_record+"' OR request_raised_by = '"+fetch_record+"'";

                            if (fetch_record.equals("")) {
                                out.println("<tr><td colspan='7' align='center' ><h3>Record Not Found</h3></td><tr>");
                            }
                        } else {
                            sql = "SELECT * FROM Request_Raise_Agent ORDER BY request_id DESC";
                        }
                    %>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="Delete_Request_Agt.jsp?id=<%= rs.getInt("request_id") %>" class="btn btn-danger" onclick="return getConfirmation()">
                                <span class="glyphicon glyphicon-trash"></span> Delete
                            </a>
                        </td>
                        <td>
                            <a href="Update_Request_Agt.jsp?id=<%= rs.getInt("request_id") %>" class="btn btn-success">
